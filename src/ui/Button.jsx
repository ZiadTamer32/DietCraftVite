...
const Button = ({
  ...
  const baseStyles =
    "font-medium rounded-md inline-flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-dietcraft-500";
  ...
  return (
    <button className={finalClassName} {...props} onClick={onClick}>
      {isPending ? (
